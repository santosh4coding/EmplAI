...
export default function EMRDashboard() {
  ...
  // Mock data for now - in production this would use real API endpoints
  const mockRecords: MedicalRecord[] = [
    {
      id: 1,
      patientId: selectedPatient?.id || 1,
      patientName: selectedPatient ? `${selectedPatient.firstName} ${selectedPatient.lastName}` : "John Doe",
      recordType: "consultation",
      title: "Annual Health Checkup",
      description: "Comprehensive health examination with blood work and vital signs assessment.",
      ...
      prescription: "Continue current blood pressure medication. Schedule follow-up in 6 months.",
      vitals: {
        temperature: 98.6,
    ...
    },
    {
      ...
      description: "Routine blood work including CBC, lipid panel, and glucose testing.",
      doctorName: "Dr. Michael Chen",
      department: "Laboratory",
      recordDate: "2025-01-30",
      chiefComplaint: "Lab work for annual physical",
      diagnosis: "All values within normal range. Cholesterol slightly elevated.",
      prescription: "Dietary modifications recommended. Recheck in 3 months.",
      severity: "low",
      status: "completed",
  ...
  const mockVitals: VitalSigns[] = [
    {
      ...
      weight: 70.5,
      height: 175,
      recordedAt: "2025-01-31T10:00:00Z"
    },
    {
      id: 2,
      patientId: selectedPatient?.id || 1,
      ...
      weight: 70.2,
      height: 175,
      recordedAt: "2025-01-25T09:30:00Z"
    }
  ];
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{mockVitals.length}</div>
                </CardContent>
              </Card>
            </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-500">
                          {record.doctorName} • {record.department} • {new Date(record.recordDate).toLocaleDateString()}
                        </div>
                      </div>
                ...
                <div className="p-4 border rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">Hematology</div>
                    </div>
                  ...
                  <div className="text-sm text-gray-500">
                    Collected: 2025-01-30 • Reported: 2025-01-30
                  </div>
                </div>
              </div>
            </CardContent>
